...
<div class="container py-4" style="max-width: 700px;">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h2 class="fw-bold mb-0" style="color:#764ba2;">➕ Thêm câu hỏi</h2>
    </div>
    <p class="text-muted mb-4">Quiz: <strong><?= htmlspecialchars($quiz['title']) ?></strong></p>

    <div class="card form-card p-4">
        <form method="POST" action="?page=store-question">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="order_index" class="form-control" value="0" min="0" style="max-width:120px;">
            </div>

            <div class="d-flex gap-2">
                <button type="submit" class="btn-save btn">💾 Lưu câu hỏi</button>
