...
/**
 * Tương đương #placeholderView (viewName = 'reports') trong _legacy/pages/admin/dashboard.html.
    ...
    <>
      <div className="page-header">
        <div className="breadcrumb">
          <Link to="/admin">Admin</Link> / <span>REPORTS</span>
        </div>
        <h1 className="page-title">Thiết lập reports</h1>
