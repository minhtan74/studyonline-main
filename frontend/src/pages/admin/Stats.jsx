...
/**
 * Tương đương #placeholderView (viewName = 'stats') trong _legacy/pages/admin/dashboard.html.
    ...
    <>
      <div className="page-header">
        <div className="breadcrumb">
          <Link to="/admin">Admin</Link> / <span>STATS</span>
        </div>
        <h1 className="page-title">Thiết lập stats</h1>
